...
class EventNameAdapter2 (private val eventList: MutableList<EventData2>,
                         private val listener: OnItemClickListener) : RecyclerView.Adapter<EventNameAdapter2.MyViewHolder>() {

    interface OnItemClickListener {
        fun onItemClick(event: EventData2)
    }
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        ...
        return EventNameAdapter2.MyViewHolder(itemView)
    }
